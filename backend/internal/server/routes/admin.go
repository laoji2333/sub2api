...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/:id/sticky-sessions", h.Admin.Account.ListStickySessions)
		accounts.POST("/:id/clear-sticky-session", h.Admin.Account.ClearStickySession)
		accounts.POST("/:id/clear-sticky-sessions", h.Admin.Account.ClearStickySessions)
