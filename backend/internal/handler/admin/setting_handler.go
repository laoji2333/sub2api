...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		PaymentExternalPaymentEnabled:                          paymentCfg.ExternalPaymentEnabled,
		PaymentExternalPaymentName:                             paymentCfg.ExternalPaymentName,
		PaymentExternalPaymentURL:                              paymentCfg.ExternalPaymentURL,
