...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountStickySessionManager := repository.ProvideAccountStickySessionManager(redisClient, db)
	...
	accountHandler := admin.ProvideAccountHandler(adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, rateLimitService, accountUsageService, accountTestService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator, grokQuotaService, accountStickySessionManager)
