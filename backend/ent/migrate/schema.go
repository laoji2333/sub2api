...
var (
	...
	ChannelMonitorsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "idx_channel_monitors_enabled_sort_order_id",
				Unique:  false,
				Columns: []*schema.Column{ChannelMonitorsColumns[13], ChannelMonitorsColumns[14], ChannelMonitorsColumns[0]},
				Annotation: &entsql.IndexAnnotation{
					DescColumns: map[string]bool{"enabled": true},
				},
			},
			{
