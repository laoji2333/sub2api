<template>
  <AppLayout>
          ...
          <template #cell-name="{ row, value }">
            <div class="flex min-w-0 flex-col">
              <HelpTooltip
                ...
                class="-ml-1 min-w-0 max-w-full self-start"
              >
                <template #trigger>
                  <a
              ...
              <span v-else :title="String(value)" class="block truncate font-medium text-gray-900 dark:text-white">{{ value }}</span>
              <span
    ...
    <AccountStickySessionsModal :show="showStickySessionsModal" :account="stickySessionsAcc" @close="closeStickySessionsModal" />
    <ScheduledTestsPanel :show="showSchedulePanel" :account-id="scheduleAcc?.id ?? null" :model-options="scheduleModelOptions" @close="closeSchedulePanel" />
    <AccountActionMenu :show="menu.show" :account="menu.acc" :anchor-rect="menu.anchorRect" @close="menu.show = false" @test="handleTest" @stats="handleViewStats" @schedule="handleSchedule" @clear-sticky-sessions="handleClearStickySessions" @duplicate="handleDuplicateAccount" @reauth="handleReAuth" @refresh-token="handleRefresh" @recover-state="handleRecoverState" @reset-quota="handleResetQuota" @set-privacy="handleSetPrivacy" @create-spark-shadow="handleCreateSparkShadow" />
...
import AccountStickySessionsModal from '@/components/admin/account/AccountStickySessionsModal.vue'
...
const showStickySessionsModal = ref(false)
...
const allColumns = computed(() => {
  const c = [
    ...
    { key: 'name', label: t('admin.accounts.columns.name'), sortable: true, class: 'w-[30ch] min-w-[30ch] max-w-[30ch]' },
...
const handleClearStickySessions = (a: Account) => {
  stickySessionsAcc.value = a
  showStickySessionsModal.value = true
}
const closeStickySessionsModal = () => {
  showStickySessionsModal.value = false
  stickySessionsAcc.value = null
}
