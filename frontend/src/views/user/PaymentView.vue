            ...
            <div v-if="enabledMethods.length >= 1 && validAmount > 0" class="card p-6">
              <div class="space-y-2 text-sm">
                ...
                <div v-if="balanceRechargeMultiplier !== 1" class="flex justify-between" :class="{ 'border-t border-gray-200 pt-2 dark:border-dark-600': feeRate <= 0 }">
                  ...
                  <span class="text-gray-900 dark:text-white">{{ moneyDisplaySymbol }}{{ creditedAmount.toFixed(2) }}</span>
                </div>
              ...
              <div class="card p-5">
                ...
                <div class="mt-3 grid grid-cols-2 gap-3">
                  ...
                  <div v-if="selectedPlan.daily_limit_usd != null">
                    ...
                    <div class="text-lg font-semibold text-gray-800 dark:text-gray-200">{{ moneyDisplaySymbol }}{{ selectedPlan.daily_limit_usd }}</div>
                  </div>
                  <div v-if="selectedPlan.weekly_limit_usd != null">
                    <span class="text-xs text-gray-400 dark:text-gray-500">{{ t('payment.planCard.weeklyLimit') }}</span>
                    <div class="text-lg font-semibold text-gray-800 dark:text-gray-200">{{ moneyDisplaySymbol }}{{ selectedPlan.weekly_limit_usd }}</div>
                  </div>
                  <div v-if="selectedPlan.monthly_limit_usd != null">
                    <span class="text-xs text-gray-400 dark:text-gray-500">{{ t('payment.planCard.monthlyLimit') }}</span>
                    <div class="text-lg font-semibold text-gray-800 dark:text-gray-200">{{ moneyDisplaySymbol }}{{ selectedPlan.monthly_limit_usd }}</div>
                  </div>
...
import { currencySymbol as paymentCurrencySymbol, DEFAULT_PAYMENT_CURRENCY, formatPaymentAmount, normalizePaymentCurrency } from '@/components/payment/currency'
...
const selectedCurrencySymbol = computed(() => paymentCurrencySymbol(selectedCurrency.value))
