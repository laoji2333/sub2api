export default {
    ...
    channelMonitor: {
      ...
      createButton: '新增监控',
      sortOrder: '卡片排序',
      sortOrderHint: '拖动调整渠道状态页面的卡片显示顺序。启用和停用渠道分别排序，启用渠道始终显示在前。',
      sortOrderUpdated: '渠道排序已更新',
      sortOrderLoadFailed: '加载渠道排序失败',
      sortOrderUpdateFailed: '更新渠道排序失败',
      enabledMonitors: '启用渠道',
      disabledMonitors: '停用渠道',
      noSortableMonitors: '暂无可排序的渠道',
      createTitle: '新增渠道监控',
      editTitle: '编辑渠道监控',
      runNow: '立即检测',
      runSuccess: '检测完成',
