export default {
    accounts: {
      ...
      editAccount: '编辑账号',
      deleteAccount: '删除账号',
      viewStickySessions: '查看粘性会话',
      clearStickySessions: '清除粘性会话',
      stickySessionsTitle: '当前账号粘性会话',
      stickySessionsSummary: '当前有效绑定 {count} 个',
      stickySessionsMetadataHint: '分组和剩余有效期来自实时缓存；用户、API Key、模型及最近请求来自近期用量日志的可靠匹配，无法匹配的会话不会猜测归属。',
      stickySessionsRetry: '重新查询',
      stickySessionsLoadFailed: '查询粘性会话失败',
      stickySessionsEmpty: '当前账号没有粘性会话',
      stickySessionsEmptyHint: '新请求仍会按照现有调度规则正常选择账号。',
      stickySession: '会话',
      stickySessionProject: '分组 / 项目',
      stickySessionUser: '用户 / API Key',
      stickySessionRecentRequest: '最近请求',
      stickySessionTTL: '剩余有效期',
      stickySessionDefaultProject: '默认分组',
      stickySessionUnmatched: '近期日志无法关联用户',
      clearStickySession: '清除此会话',
      clearAllStickySessions: '清除全部',
      clearStickySessionConfirm: '确定清除会话“{fingerprint}”吗？该会话下次请求时会重新调度。',
      clearStickySessionsConfirm: '确定清除账号“{name}”当前的 {count} 个粘性会话吗？账号状态、优先级和并发配置不会改变；相关会话下次请求时会重新调度。',
      clearStickySessionsConfirmAction: '确认清除',
      clearStickySessionSuccess: '已清除该粘性会话',
      clearStickySessionChanged: '该会话已过期或已重新绑定，列表已刷新',
      clearStickySessionsSuccess: '已清除 {count} 个粘性会话',
      clearStickySessionsFailed: '清除粘性会话失败',
      stickySessionTTLSeconds: '{count} 秒',
      stickySessionTTLMinutes: '{count} 分钟',
      stickySessionTTLHours: '{count} 小时',
      stickySessionTTLNoExpiry: '无过期时间',
      searchAccounts: '搜索账号...',
      notes: '备注',
