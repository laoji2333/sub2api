export default {
    settings: {
      ...
      site: {
        ...
        qqGroupNumber: 'QQ群号',
        qqGroupNumberHint: '与入群链接同时配置后，会在用户端顶部显示加入入口',
        qqGroupNumberPlaceholder: '请输入QQ群号',
        qqGroupJoinUrl: 'QQ群入群链接',
        qqGroupJoinUrlHint: '仅支持 http 或 https 链接',
        qqGroupJoinUrlPlaceholder: 'https://qm.qq.com/...',
        qqGroupDescription: 'QQ群说明文本',
        qqGroupDescriptionHint: '显示在“点击加入QQ群”按钮下方，支持换行，留空则不显示',
        qqGroupDescriptionPlaceholder: '输入需要展示的说明文本',
        apiBaseUrl: 'API 端点地址',
      ...
      payment: {
        ...
        externalPaymentTitle: '外部支付',
        externalPaymentDesc: '在充值页的支付方式末尾展示一个外部充值入口',
        externalPaymentName: '支付方式名称',
        externalPaymentNamePlaceholder: '如：外部充值',
        externalPaymentUrl: '外部链接',
        externalPaymentUrlHint: '启用后，用户点击该支付方式会在新标签页打开此链接',
