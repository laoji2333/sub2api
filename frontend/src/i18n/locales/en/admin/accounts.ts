export default {
    accounts: {
      ...
      viewStickySessions: 'View Sticky Sessions',
      clearStickySessions: 'Clear Sticky Sessions',
      stickySessionsTitle: 'Account Sticky Sessions',
      stickySessionsSummary: '{count} active binding(s)',
      stickySessionsMetadataHint: 'Group and expiry come from the live cache. User, API key, model, and recent request details are shown only when reliably matched from recent usage logs.',
      stickySessionsRetry: 'Try Again',
      stickySessionsLoadFailed: 'Failed to load sticky sessions',
      stickySessionsEmpty: 'This account has no sticky sessions',
      stickySessionsEmptyHint: 'New requests will continue to use the current scheduling rules.',
      stickySession: 'Session',
      stickySessionProject: 'Group / Project',
      stickySessionUser: 'User / API Key',
      stickySessionRecentRequest: 'Recent Request',
      stickySessionTTL: 'Expires In',
      stickySessionDefaultProject: 'Default Group',
      stickySessionUnmatched: 'No reliable user match in recent logs',
      clearStickySession: 'Clear Session',
      clearAllStickySessions: 'Clear All',
      clearStickySessionConfirm: 'Clear session “{fingerprint}”? It will be rescheduled on its next request.',
      clearStickySessionsConfirm: 'Clear the {count} current sticky session(s) bound to “{name}”? The account status, priority, and concurrency settings will not change. Affected sessions will be rescheduled on their next request.',
      clearStickySessionsConfirmAction: 'Clear Sessions',
      clearStickySessionSuccess: 'Sticky session cleared',
      clearStickySessionChanged: 'The session expired or was rebound. The list has been refreshed.',
      clearStickySessionsSuccess: 'Cleared {count} sticky session(s)',
      clearStickySessionsFailed: 'Failed to clear sticky sessions',
      stickySessionTTLSeconds: '{count}s',
      stickySessionTTLMinutes: '{count}m',
      stickySessionTTLHours: '{count}h',
      stickySessionTTLNoExpiry: 'No expiry',
