export default {
    ...
    channelMonitor: {
      ...
      sortOrderHint: 'Drag to reorder cards on the channel status page. Enabled and disabled channels are ordered separately, with enabled channels always shown first.',
      sortOrderUpdated: 'Channel order updated',
      sortOrderLoadFailed: 'Failed to load channel order',
      sortOrderUpdateFailed: 'Failed to update channel order',
      enabledMonitors: 'Enabled channels',
      disabledMonitors: 'Disabled channels',
      noSortableMonitors: 'No channels to sort',
