export default {
    settings: {
      ...
      payment: {
        ...
        externalPaymentTitle: 'External Payment',
        externalPaymentDesc: 'Show one external recharge option after the payment methods',
        externalPaymentName: 'Payment Method Name',
        externalPaymentNamePlaceholder: 'e.g. External Recharge',
        externalPaymentUrl: 'External URL',
        externalPaymentUrlHint: 'When enabled, clicking this option opens the URL in a new tab',
