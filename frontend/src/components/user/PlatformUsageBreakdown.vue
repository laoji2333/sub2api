<template>
  <div class="group/usage relative text-sm">
    <div class="flex items-center gap-1.5">
      ...
      <span class="font-medium text-gray-900 dark:text-white">{{ moneyDisplaySymbol }}{{ today.toFixed(4) }}</span>
      <Icon
        v-if="hasBreakdown"
        name="infoCircle"
        size="xs"
    ...
    <div class="mt-0.5 flex items-center gap-1.5">
      ...
      <span class="font-medium text-gray-900 dark:text-white">{{ moneyDisplaySymbol }}{{ total.toFixed(4) }}</span>
    </div>
    ...
    >
      ...
      >
        ...
        <span class="font-mono">
          {{ moneyDisplaySymbol }}{{ item.today_actual_cost.toFixed(4) }}
          <span class="opacity-50">/</span>
          {{ moneyDisplaySymbol }}{{ item.total_actual_cost.toFixed(4) }}
        </span>
      </div>
    </div>
  </div>
