          ...
          >
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-white">
             ...
             <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              ...
              <span class="text-gray-400 dark:text-gray-500">
                ({{ t('usage.userBilled') }}: {{ moneyDisplaySymbol }}{{ formatCost(stats.summary.avg_daily_user_cost) }})
              </span>
            </p>
          </div>
          ...
          <div class="card p-4">
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-semibold text-gray-900 dark:text-white"
                  >{{ moneyDisplaySymbol }}{{ formatCost(stats.summary.today?.user_cost || 0) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
          ...
          <div class="card p-4">
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('usage.userBilled') }}</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-white"
                  >{{ moneyDisplaySymbol }}{{ formatCost(stats.summary.highest_cost_day?.user_cost || 0) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-500 dark:text-gray-400">{{
          ...
          <div class="card p-4">
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('usage.userBilled') }}</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-white"
                  >{{ moneyDisplaySymbol }}{{ formatCost(stats.summary.highest_request_day?.user_cost || 0) }}</span
                >
              </div>
            </div>
          </div>
