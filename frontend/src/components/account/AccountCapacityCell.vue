<template>
  <div class="flex flex-col gap-0.5">
    ...
    <!-- 5h窗口费用限制 -->
    <CapacityBadge v-if="showWindowCost" :color-class="windowCostClass" :tooltip="windowCostTooltip" :current="moneyDisplaySymbol + formatCost(currentWindowCost)" :max="moneyDisplaySymbol + formatCost(account.window_cost_limit)">
      <svg class="h-2.5 w-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
