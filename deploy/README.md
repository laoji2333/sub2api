...
| `docker-compose.prod.yml` | CVAPI production override: immutable GHCR application image |
| `CVAPI_DEPLOY_CN.md` | CVAPI single-server production, update, backup, migration, and rollback guide |
