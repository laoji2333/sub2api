...
| `docker-compose.prod.yml` | CVAPI production override: immutable GHCR image, Railway PostgreSQL, local Redis |
| `CVAPI_DEPLOY_CN.md` | CVAPI production, Railway PostgreSQL, update, backup, and rollback guide |
