...
| `docker-compose.prod.yml` | CVAPI production override: immutable GHCR image, Railway PostgreSQL, external Redis |
| `CVAPI_DEPLOY_CN.md` | CVAPI production, external data services, update, backup, and rollback guide |
